...
It includes all Pools (clickeable) information and the Schedule of each game.
...
Then create a new dashboard (I used Panel (Single Card)), add a new card and copy the code in the wbccard.txt file.
